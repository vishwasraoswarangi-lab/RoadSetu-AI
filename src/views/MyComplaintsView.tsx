        ...
        {filtered.length === 0 ? (
          <section className="rounded-3xl border border-dashed border-slate-300 bg-white p-12 text-center">
            ...
            <p className="mx-auto mt-2 max-w-md text-sm text-slate-500">
              Try changing your search or filters, or submit a new
              pothole report.
            </p>
                    ...
                    <div className="flex-1 p-5 sm:p-6">
                      <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <span
                            className={`inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-[10px] font-bold uppercase ${status.className}`}
                          >
                        ...
                        <div>
                          ...
                          {c.location.landmark && (
                            <p className="ml-6 mt-1 text-xs font-medium text-blue-600">
                              {c.location.landmark}
                            </p>
                          )}
